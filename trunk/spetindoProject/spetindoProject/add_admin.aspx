<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_admin.aspx.cs" Inherits="spetindoProject.add_admin" %>
                ...
                <div class="register_area">
						  ...
						  <div class="register_bodyarea">
							<div class="register_head">
							  <div align="center">ISI DATA ADMIN YANG AKAN DITAMBAHKAN</div>
							</div>
							<div class="register_textbox">
								<table>
									...
									<tr>
										<td>Password</td>
										<td><asp:TextBox ID="TextBoxPass" runat="server"></asp:TextBox></td>
									</tr>
									<tr>
										<td colspan="2"></td>
									</tr>
