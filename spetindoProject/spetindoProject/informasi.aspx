    ...
    <form id="form1" runat="server">
		...
		<div id="header_strip"></div>
		 ...
		 <div id="body_area">
			...
			<div class="midarea">
				<div class="head"> Informasi Pengukuran 
				...
				<asp:Panel ID="panelIsiUtama" runat="server" Visible="true">
					<div class="body_textarea">
						<div align="justify">Jenis Tanah </div>
                        <div align="justify">1. Tanah Aluvial : Tanah Aluvial disebut juga tanah endapan karena terbentukdari endapan lumpur yang terbawa air hujan ke dataran rendah. Tanah ini bersifat subur karena terbentuk dari kikisan tanah humus.</div>
					    <div align="justify">2. Tanah Litosol : Tanah litosol merupakan jenis tanah berbatu-batu dengan lapisan tanah yang tidak begitu tebal. Bahannya berasal dari jenis batuan beku yang belum mengalami proses pelapukan secara sempurna. Jenis tanah ini banyak ditemukan di lereng gunung dan pegunungan di seluruh Indonesia. </div>
                    </div>
					</div>	
                </asp:Panel>
			</div>
